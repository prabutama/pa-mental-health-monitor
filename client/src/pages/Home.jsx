    ...
    <div className="w-full top-0 left-0">
      ...
      <div className="mainTop p-10 pt-36 flex flex-col md:flex-row gap-16" id="home">
        <div className="textMain flex-1">
          ...
          <Link to="/check">
            <Button className="bg-green-700 mt-8 hover:bg-green-900 text-white font-semibold px-8 py-4 rounded-full md:px-10 md:py-5">
              Get Started
            </Button>
          </Link>
        </div>
      ...
      <div className="bestChoice p-10 text-center">
        <h1 className="text-2xl md:text-4xl font-semibold px-4 md:px-60">
        ...
        <div className="list pt-20">
          <ul className="flex flex-wrap justify-center items-center space-x-4 md:space-x-10">
            <li>
              <div className="holistic mx-auto rounded-3xl p-6 md:p-10 flex flex-col justify-center items-center w-72 h-80 border-4 border-black hover:text-white ease-in duration-100 hover:bg-gradient-to-l from-green-700 to-green-300 hover:border-white hover:scale-125">
                <svg
                  width="114"
                  height="132"
                  viewBox="0 0 114 132"
                ...
                <h1 className="font-semibold pt-3 text-lg md:text-xl">
                  Holistic Approach
                </h1>
                <h1 className="pt-5 text-sm md:text-base">
                  Aligning mind, body, and spirit for overall well-being
                </h1>
              </div>
            </li>
            <li>
              <div className="expertise mx-auto rounded-3xl p-6 md:p-10 mr-4 mt-3 flex flex-col justify-center items-center w-72 h-80 border-4 border-black hover:text-white ease-in duration-100 hover:bg-gradient-to-l from-green-700 to-green-300 hover:border-white hover:scale-125">
                <svg
                  width="144"
                  height="132"
                  viewBox="0 0 149 168"
            ...
            <li>
              <div className="accessibility mx-auto rounded-3xl p-6 md:p-10 mr-4 mt-3 flex flex-col justify-center items-center w-72 h-80 border-4 border-black hover:text-white ease-in duration-100 hover:bg-gradient-to-l from-green-700 to-green-300 hover:border-white hover:scale-125">
                <svg
                  width="144"
                  height="132"
                  viewBox="0 0 108 105"
      ...
      <div className="aboutUS p-10 pt-20 flex flex-col md:flex-row">
        ...
        <div className="textAboutUs md:w-1/2 md:pl-10">
          <h1 className="pt-10 text-4xl">
      ...
      <div className="services p-10 pt-24 text-center">
        ...
        <div className="listServices pt-20">
          <ul className="flex flex-col md:flex-row justify-center md:justify-between space-y-10 md:space-y-0">
            ...
            <li>
              <div className="konseling w-80 h-64 p-5 border-2 border-black rounded-3xl">
            ...
            <li>
              <div className="janjiDokter w-80 h-64 p-5 border-2 border-black rounded-3xl">
      ...
      <div id="artikel" className="pt-20">
        ...
        <div className="listArtikel pt-10">
          <ul className="flex flex-col md:flex-row justify-center md:justify-evenly gap-4">
            <li className="flex justify-center">
              <div className="artikel1 w-[300px] h-[320px] border-2 border-black rounded-lg overflow-hidden">
                <img src={artikel1} className="w-full h-1/2 object-cover" />
            ...
            <li className="flex justify-center">
              <div className="artikel2 w-[300px] h-[320px] border-2 border-black rounded-lg overflow-hidden">
                <img src={artikel2} className="w-full h-1/2 object-cover" />
            ...
            <li className="flex justify-center">
              <div className="artikel3 w-[300px] h-[320px] border-2 border-black rounded-lg overflow-hidden">
                <img src={artikel3} className="w-full h-1/2 object-cover" />
                <h1 className="font-semibold text-base mt-3 pr-3 pl-3">
            ...
            <li className="flex justify-center">
              <div className="artikel4 w-[300px] h-[320px] border-2 border-black rounded-lg overflow-hidden">
                <img src={artikel4} className="w-full h-1/2 object-cover" />
                <h1 className="font-semibold text-base mt-3 pr-3 pl-3">
      ...
      <footer className="pt-60">
        <div className="footer bg-gradient-to-r p-20 from-green-700 to-green-300">
          ...
          <h1 className="text-white text-center mt-10 underline">
            Copyright 2024 @mindtrack all rights reserved
          </h1>
        </div>
      </footer>
    </div>
